/* parserGrammar.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. parserGrammar.java */
import java.io.*;

public class parserGrammar/*@bgen(jjtree)*/implements parserGrammarTreeConstants, parserGrammarConstants {/*@bgen(jjtree)*/
  protected JJTparserGrammarState jjtree = new JJTparserGrammarState();public static int NumberErrors=0;
...
try {ParseException e = generateParseException();  // generate the exception object.
  ...
  void skipto_do_not_consume_last(int kind) throws ParseException {/*@bgen(jjtree) skipto_do_not_consume_last */
...
try {ParseException e = generateParseException();  // generate the exception object.
  ...
  void printMessagesError(ParseException exception) throws ParseException {/*@bgen(jjtree) printMessagesError */
     ASTprintMessagesError jjtn000 = new ASTprintMessagesError(JJTPRINTMESSAGESERROR);
     boolean jjtc000 = true;
     jjtree.openNodeScope(jjtn000);
     try {if(NumberErrors == 0) {
                System.out.println("ERROR FOUND!");
        }

        NumberErrors++;

        System.out.println("Error number: " + NumberErrors);

        System.out.println("Found this character: " + exception.currentToken.next.image + " in Row " +
        exception.currentToken.beginLine + " and in Column " +
  ...
  final public ASTModule Module() throws ParseException {/*@bgen(jjtree) Module */
    ...
    try {
      try {
        ...
        case ASSIGN:{
          ...
          switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
          case LPAR_RECT:{
            jj_consume_token(LPAR_RECT);
            ArraySize();
            jj_consume_token(RPAR_RECT);
            break;
            }
          case ADDSUB_OP:
          case INTEGER:{
...
jjtn000.setNameInteger(t2.image);
            break;
            }
          default:
            jj_la1[4] = jj_gen;
...
System.out.println("CATCH WHILE");
  ...
  final public void CallStmt() throws ParseException {/*@bgen(jjtree) CallStmt */
...
System.out.println("CATCH CALLSTMT");
                skipto(RPAR);
...
if (jjtc000) {
  ...
  final public void ErrorBlock() throws ParseException {/*@bgen(jjtree) ErrorBlock */
...
if (jjtc000) {
  ...
  private boolean jj_3_1()
 {
    if (jj_scan_token(ID)) return true;
    if (jj_scan_token(LPAR_RECT)) return true;
    if (jj_scan_token(RPAR_RECT)) return true;
    return false;
  }
  ...
  private boolean jj_3_5()
 {
  ...
  public parserGrammarTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x40000000,0x800000,0x40000000,0x100,0x24000100,0x8000,0x40000000,0x800000,0x40000000,0x40000000,0x80000,0x40000000,0x40003000,0x3000,0x40000000,0x40000000,0x700,0x700,0x64000100,0x60000000,0x100,0x20000000,0x40000000,0x4000,0x10000000,0x60000000,0x10000000,0x60000000,0x80000,0x60000000,0x10000000,0x60000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x2,0x0,0x2,0x0,0x0,};
   }
